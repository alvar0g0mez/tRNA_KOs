...
## Print to PDF
ggsave(
   filename = "C:/MyStuff/tRNA_KOs/Output/Plots/Volcano_plots/DE_per_batch/volcano_plots_per_KO_all_KOs_per_batch.pdf", 
...
## Print to PDF
ggsave(
   filename = "C:/MyStuff/tRNA_KOs/Output/Plots/Volcano_plots/DE_per_batch/volcano_plots_per_KO_KOs_with_DE_proteins_per_batch.pdf", 
   plot = marrangeGrob(my_grobs, nrow=4, ncol=4), 
   width = 15, height = 9
)
...
## Print to PDF
ggsave(
   filename = "C:/MyStuff/tRNA_KOs/Output/Plots/Volcano_plots/DE_per_batch/volcano_plots_per_KO_UCU_family_per_batch.pdf", 
   plot = marrangeGrob(my_grobs, nrow=4, ncol=4), 
   width = 15, height = 9
)
