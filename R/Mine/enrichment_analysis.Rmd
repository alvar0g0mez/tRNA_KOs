...
## 2.5. Plot most frequent EA terms across all strains
```{r}
# Prepare dataframe
...
## 4.3. Come up with a count of the enriched pathways throughout each set of strains
Get dataframes
```{r}
...
# 5. GSEA - try to imitate the results from the original article
...
## 5.2. Perform GSEA with KEGG annotation
...
## 5.3. Perform GSEA with Reactome annotation??
