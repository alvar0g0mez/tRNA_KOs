...
Grab the systematic names of the RNA pol III subunits from the UniProt dataset and check how many of them are up- or down-regulated in each KO strain
```{r}
# Grab subunit names
...
# Iterate over strains and check DE of the subunits
strains <- unique(da$Strain.Name)
subunits_upregulated <- 

for (strain in strains) {
  temp <- da %>%
    dplyr::filter(Strain.Name == strain &
                  protein %in% rna_pol_3_subunits)
}
```
