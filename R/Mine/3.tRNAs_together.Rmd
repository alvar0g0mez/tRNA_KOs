...
TRYING OTHER VERSIONS OF THE PLOT FROM CHATGPT - THIS IS ACTUALLY THE BEST VERSION OF THE LOLLIPOP PLOT, SHOULD ORGANIZE THIS A LITTLE BIT
```{r}
tile_x <- -50
...
create_heatmap(protein_mat = trna_ko,
               ...
               save_as = "png",
               plot_name = "heatmap_raw_clustered_samples",
               heatmap_title = "Raw tRNA KOs heatmap, full proteomes")
```
...
create_heatmap(protein_mat = trna_ko,
               ...
               location_to_save = paste(base_dir, "tRNA_KOs/Output/Plots/Heatmaps/", sep=""),
               save_as = "png",
               plot_name = "heatmap_z_score_clustered_samples",
...
create_heatmap(protein_mat = trna_ko,
               ...
               location_to_save = paste(base_dir, "tRNA_KOs/Output/Plots/Heatmaps/", sep=""),
               save_as = "png",
               plot_name = "heatmap_log2FC_clustered_samples",
               heatmap_title = "Z-score tRNA KOs heatmap, full proteomes")
```
