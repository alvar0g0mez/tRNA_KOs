...
## 6.2. Get some upset plots for this
...
## 6.3. Create a dataframe where I look at the overlaps between all KOs, collecting all possible information in the columns 
...
### 6.3.3. Look at pairs with Jaccard index over 0.5
...
### 6.3.4. Test and plot for Jaccard Index across different variables (same amino acid, same anticodon, same chromosome, same amino acid charge, same amino acid type...)
```{r}
