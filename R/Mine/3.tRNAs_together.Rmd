...
phenotypic_data <- as.data.frame(fread('C:/MyStuff/tRNA_KOs/Data/Other/bloom_ackermann_2014/phenotypic_results.tsv'))
...
## 3.1. Come up with plots with nDEP vs. expression
...
Plots - I DON'T KNOW IF "SUBSET()" IS WORKING???
```{r}
