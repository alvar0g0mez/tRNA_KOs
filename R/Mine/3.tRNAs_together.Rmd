...
Correlation between CV and nDEP - are the more variable strains the ones that we find no DEPs for, precisely due to the variability within them?
```{r}
...
# Let's do the same with CV instead of MAD, I think it makes more sense
proteomics_data_log2_long <- proteomics_data_log2_long %>%
  group_by(Strain.Name, protein) %>%
