...
print("You are trying to load DEA results. At which logFC threshold do you want them?")
lfc <- readline()
print("And at which p-value? Please provide it as '001' or '005'")
pval <- readline()
print("Thanks! Coming right up :)")

# List of dataframes with the proteins that were DE in each KO strain
de_proteins_list <- fromJSON(paste(base_dir, "Data/Other/enrichment_analysis/de_proteins_list_", pval, "_", "logFC_", lfc, ".json", sep=""))
