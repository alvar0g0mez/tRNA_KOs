...
responsiveness <- responsiveness %>%                    
  dplyr::arrange(Amino_acid_1_letter, desc(Family_type), anticodon, nDEP)
responsiveness$anticodon <- factor(responsiveness$anticodon, levels = unique(responsiveness$anticodon))
...
lollipop_plot_final <- ggplot(responsiveness, aes(x = nDEP, y = anticodon)) +
  # Background color block
  geom_tile(data = annotation_data, aes(fill = Amino_acid_1_letter), x = tile_x_2, width = 30, height = 0.8) +
  geom_tile(data = annotation_data, aes(fill = Family_type), x = tile_x, width = 30, height = 0.8) +
...
lollipop_plot_final <- ggplot(responsiveness, aes(x = nDEP, y = anticodon)) +
  # First tile column
  geom_tile(data = annotation_data, aes(fill = Amino_acid_1_letter), x = tile_x_2, width = 30, height = 0.8) +
  scale_fill_viridis_d(name = "Amino Acid") +
