...
# Initiation rate data from Riba et al., 2019
initiation_rate_oligo_dt <- as.data.frame(fread(paste(base_dir, "tRNA_KOs/Data/Articles/riba_2019/sup_dataset_1.tsv", sep="")))
```

Select proteins with a high initiation rate
```{r}
median_initiation_rate <- median(initiation_rate$real_protein_synthesis_per_mrna)           # just as a reference, I'm using a higher value anyway
genes_with_high_initiation_rate <- initiation_rate$ensembl_gene_id[initiation_rate$real_protein_synthesis_per_mrna > 1.5]
```
