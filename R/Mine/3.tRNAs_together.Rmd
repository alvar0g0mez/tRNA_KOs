...
# Remove unnecesary variables
rm(amino_acids, DE, de_proteins_list_001, fit, fit2, KOs_replicates, mm, temp, trna_ko_log, trna_levels,
   yeastmine, final_protein_names, general_protein_names, i, KO, output_file, replicates, sample_name, standard_protein_names, strain_name,
   systematic_protein_names, trna_levels, unique_KOs, trna_ko, dpcfit, y.protein)
```
