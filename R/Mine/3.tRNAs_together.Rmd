...
Need to print a list of the codons (in DNA code) to iterate over them in the Python script
```{r}
# Load responsiveness dataset
responsiveness <- as.data.frame(fread(paste(base_dir, "tRNA_KOs/Data/produced_during_analysis/responsiveness_", alpha_plain, "_logFC_", as.character(lfc_threshold), ".csv", sep="")))
...
Load the data obtained in Python
```{r}
# Load the data
...
# Pivot longer, add information from master_dataset, filter for high proportion of target codon
