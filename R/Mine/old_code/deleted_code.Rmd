...
## 1.7. Now I have the lollipop plot for this which is much nicer, before I had these barplots
If I ever want to run this again, I will need to fix the paths to which the plots/pdfs are saved, they are missing "paste(" at the beginning and ", sep="")" at the end. 
...
fwrite(responsiveness, "/home/alvaro/MyStuff/Projects/tRNA_KOs/Data/produced_during_analysis/responsiveness_", alpha_plain, "_logFC_", as.character(lfc_threshold), ".csv")
...
## Print to PDF
output_file = "/home/alvaro/MyStuff/Projects/tRNA_KOs/Output/Plots/nDEP_per_families/histograms/nDEP_hists_per_isoacceptors_color_by_codon_", alpha_plain, "_logFC_", as.character(lfc_threshold), ".pdf"
ggsave(
...
## Print to PDF
output_file = "/home/alvaro/MyStuff/Projects/tRNA_KOs/Output/Plots/nDEP_per_families/histograms/nDEP_hists_per_anticodon_color_by_DNA_seq_", alpha_plain, "_logFC_", as.character(lfc_threshold), ".pdf"
ggsave(
   filename = output_file, 
   plot = marrangeGrob(my_grobs_DNA, nrow=4, ncol=4), 
   width = 15, height = 9
)
output_file = "/home/alvaro/MyStuff/Projects/tRNA_KOs/Output/Plots/nDEP_per_families/histograms/nDEP_hists_per_anticodon_color_by_mature_seq_", alpha_plain, "_logFC_", as.character(lfc_threshold), ".pdf"
ggsave(
   filename = output_file, 
   plot = marrangeGrob(my_grobs_mature, nrow=4, ncol=4), 
   width = 15, height = 9
)
output_file = "/home/alvaro/MyStuff/Projects/tRNA_KOs/Output/Plots/nDEP_per_families/histograms/nDEP_hists_per_anticodon_", alpha_plain, "_logFC_", as.character(lfc_threshold), ".pdf"
ggsave(
   filename = output_file, 
...
## Print to PDF
output_file = "/home/alvaro/MyStuff/Projects/tRNA_KOs/Output/Plots/nDEP_per_families/histograms/nDEP_hists_per_anticodon_only_1_major_", alpha_plain, "_logFC_", as.character(lfc_threshold), ".pdf"
ggsave(
   filename = output_file, 
   plot = marrangeGrob(my_grobs, nrow=4, ncol=4), 
   width = 15, height = 9
...
## Print to PDF
output_file = "/home/alvaro/MyStuff/Projects/tRNA_KOs/Output/Plots/nDEP_per_families/histograms/nDEP_hists_per_anticodon_more_than_1_major_", alpha_plain, "_logFC_", as.character(lfc_threshold), ".pdf"
ggsave(
   filename = output_file, 
   plot = marrangeGrob(my_grobs, nrow=4, ncol=4), 
   width = 15, height = 9
...
## Print to PDF
output_file = "/home/alvaro/MyStuff/Projects/tRNA_KOs/Output/Plots/nDEP_per_families/histograms/nDEP_hists_per_anticodon_nDEP_below_20_", alpha_plain, "_logFC_", as.character(lfc_threshold), ".pdf"
ggsave(
   filename = output_file, 
   plot = marrangeGrob(my_grobs, nrow=4, ncol=4), 
   width = 15, height = 9
